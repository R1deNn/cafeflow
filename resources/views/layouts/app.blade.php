...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="fixed top-0 border-solid border-gray-200 w-full py-3 bg-white z-50  bg-inherit">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="md:flex md:justify-between">
                    <div class="mb-8 md:mb-0">
                        <a href="/" class="flex items-center">
                            ...
                            <span class="ml-2 text-xl font-bold">BusyBee</span>
                        </a>
                        <p class="mt-2 text-gray-400">
                            Умная аналитика для вашего бизнеса.
                        </p>
                    </div>
                    <div class="grid grid-cols-2 gap-8">
                        <div>
                            <h3 class="text-sm font-semibold text-gray-300 tracking-wider uppercase">Компания</h3>
                            <ul class="mt-4 space-y-2">
                                <li><a href="#" class="text-gray-400 hover:text-yellow-500">О нас</a></li>
                                <li><a href="#" class="text-gray-400 hover:text-yellow-500">Контакты</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 class="text-sm font-semibold text-gray-300 tracking-wider uppercase">Правовая информация</h3>
                            <ul class="mt-4 space-y-2">
                                <li><a href="#" class="text-gray-400 hover:text-yellow-500">Политика конфиденциальности</a></li>
                                <li><a href="#" class="text-gray-400 hover:text-yellow-500">Условия использования</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
                    <p class="text-gray-400 text-sm">
                        © 2023 BusyBee. Все права защищены.
                    </p>
                </div>
            </div>
        </footer>
